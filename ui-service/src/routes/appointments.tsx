cat >
  (~/clinicos/cciilnos - hub - main / src / routes / appointments.tsx) << "EOF";
...
export const TYPE_COLORS: Record<AppointmentType, { bg: string; fg: string }> =
  {
    Consultation: {
      ...
      fg: "var(--clinic-blue-strong)",
    },
    "Follow-up": {
      bg: "var(--clinic-indigo-soft)",
      fg: "var(--clinic-indigo)",
    },
        ...
        {user.role !== "PATIENT" && (
          <Card className="flex flex-wrap items-center gap-3 p-3">
            <Tabs
              value={statusFilter}
              onValueChange={(v) =>
                setStatusFilter(v as "ALL" | AppointmentStatus)
              }
            >
              <TabsList>
                          ...
                          <div className="flex justify-end gap-1">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                setForm({
                                  ...a,
                                  datetime: dayjs(a.datetime).format(
                                    "YYYY-MM-DDTHH:mm",
                                  ),
                                });
                                setOpen(true);
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    value={form.duration}
                    onValueChange={(v) =>
                      setForm({ ...form, duration: v as AppointmentDuration })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    value={form.payment ?? ""}
                    onValueChange={(v) =>
                      setForm({ ...form, payment: v as PaymentMethod })
                    }
                  >
                    <SelectTrigger>
                ...
                <Popover open={reasonOpen} onOpenChange={setReasonOpen}>
                  ...
                  >
                    <Command shouldFilter={false}>
                      ...
                      <CommandList>
                        <CommandEmpty>
                          Press enter to use this reason.
                        </CommandEmpty>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {patientMap[detail.patientId] ?? "—"}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Doctor</span>
                  <span className="font-medium">
                    {doctorMap[detail.doctorId] ?? "—"}
                  </span>
                </div>
                <div className="flex items-center justify-between">
